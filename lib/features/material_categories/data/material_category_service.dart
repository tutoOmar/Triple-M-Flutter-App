...
class MaterialCategoryService {
  MaterialCategoryService(this._firestore);
...
final materialCategoryServiceProvider = Provider<MaterialCategoryService>((ref) {
  return MaterialCategoryService(ref.watch(firebaseFirestoreProvider));
});
